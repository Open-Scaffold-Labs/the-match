...
- [[synthesis/next-session-handoff-2026-06-29]] — **ACTIVE handoff** — pick up the user-facing **Eagle Eye accuracy + visual flow** work. F.5 (S1–S7) is COMPLETE + live; the next push is Phase 0 foundation (tokens/type/motion — none done), Eagle Eye accuracy polish (graded GPS chip, club-arc dispersion bands, battery/instant-on, held range-rings), app-wide polish + the EagleEye inline-style→token refactor, then remaining leapfrogs (ad-free free tier, green slope+putt-line, AR). Reusable tools, prod flag state, standing rules, key files · created 2026-06-29
