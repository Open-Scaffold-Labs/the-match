...
- Applied: (a) **main** — `client/ios/App/App/Assets.xcassets/AppIcon.appiconset/AppIcon-512@2x.png` (was blue-X) → committed+pushed `main`; (b) **feat/watch-w0** — `ios/TheMatch` + `ios/TheMatchWatch` AppIcon `icon-1024.png` (was gold flag) → committed+pushed the branch (`790e9b0`), commit message flags Dale directly that it was an art call per Matt, revertable if he wants the flag for the watch face.
