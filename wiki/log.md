...
- **NOT verified:** sign-in actually succeeding on Matt's physical device — only he can confirm. Also assumed (not device-confirmed) that his build reports `version_build` "1.0"; the endpoint gate was tested with that value.
