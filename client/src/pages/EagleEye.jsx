  ...
  return (
    ...
    <div data-no-pull-refresh="true" style={{ position: 'fixed', inset: 0, background: 'var(--tm-ee-bg)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        {/* 2026-08-08 — this row overflowed the viewport on a real iPhone: the
            right-hand pill group (GPS + wind + temp + SCORECARD) is wider than
            the space left over, and NOTHING here declared shrink behaviour. The
            browser's default (flex-shrink:1, min-width:auto) squeezed the title
            column until "EAGLE EYE" broke onto two lines and a 3-word course
