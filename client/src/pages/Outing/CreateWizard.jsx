...
// /api/courses/search). Extracted to components/CoursePicker.jsx
// (variant="inline") — Phase 1 / S1b of the Play-funnel plan (2026-07-10);
// this file's light-field JSX moved verbatim. Re-exported here so existing
// importers (solo SetupSheet in ActiveRound.jsx, exported 2026-05-07)
// keep working unchanged. (Imported into local scope too — the wizard's own
// step-0 JSX renders it.)
